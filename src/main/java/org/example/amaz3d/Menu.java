...
import org.example.amaz3d.controller.networking.HostMenu;
...
import org.example.amaz3d.view.MultiView;
import org.example.amaz3d.view.SingleView;
...
public class Menu extends Application {
    ...
    public void initRank(StackPane stack,VBox ranking,VBox menu){
      ...
      solos.setOnMouseClicked(e->{
              config(ranking,Constants.TEXT_RESOURCES_PATH + File.separator + "bestSolos.txt" ,stack,menu);
          });
      Button trial = new Button("Against the clock");
      trial.setOnMouseClicked(e->{
              config(ranking, Constants.TEXT_RESOURCES_PATH + File.separator + "bestRaces.txt",stack,menu);
          });
    ...
    public void start(Stage stage) throws FormatNotSupported, IOException {
        ...
        File folder = new File(Constants.SAVING_RESOURCES_PATH);
        ...
        /*if(file!=null){
            ...
            view=controller.MazeInterface.getView(new model.Maze(file),type);
        }*/
       ...
       /*Panneau pour les choix avec un chargement de fichier*/
        ...
        stage.setTitle("view.Menu of Maz3D");
        ...
        scene.getStylesheets().add(Constants.getCssResourcePath("menu.css"));
                //Constants.CSS_RESOURCES_PATH + File.separator +"menu.css");
    ...
    public static void addCss(Dialog a) {
        ...
        dialogPane.getStylesheets().add(Constants.getCssResourcePath("alert.css"));
    ...
    private static void configureFileChooser(final FileChooser fileChooser) {
        fileChooser.setTitle("view.View Files");
