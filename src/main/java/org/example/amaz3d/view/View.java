...
import org.example.amaz3d.controller.*;
...
import org.example.amaz3d.model.*;
...
public class View extends Scene {
    ...
    */
    ...
    protected class MazePane extends Group {
        ...
        public Vector3D[] getCoordSwitch() {
            return coordSwitch;
        }

        public int getSIZE_BOX() {
            return SIZE_BOX;
        }
        ...
        */
        public void initMaze() throws IOException {
            ...
            Point before = null;
            Box square = null;
            COLOR_WALL.setBumpMap(new Image(Constants.getImgResourcePath("brick.jpg")));
            COLOR_WALL.setSpecularColor(Color.BLACK);
            COLOR_DOOR.setDiffuseMap(new Image(Constants.getImgResourcePath("safe.jpg")));
        ...
        /**
          Création de la vue d'un étage de labyrinthe selon l'objet model.Maze donné en argument
        */
        ...
        */
        ...
        public void drawKey(Group root, int posx, int posy, int floor) throws IOException {
            ...
            fxmlLoader.setLocation(Constants.getFxmlResource("key.fxml"));
            //fxmlLoader.setLocation(this.getClass().getResource("org/example/amaz3d/fxml/key.fxml"));
        ...
        public void drawObstacle(Group root, int i, int j, int floor, Maze maze) throws IOException {
            ...
            if (maze.getTypeObstacle().equals("Cercle")) {
                fxmlLoader.setLocation(Constants.getFxmlResource("Spider.fxml"));
                scale =  2.1f;
                scaleZ = 2.5f;
                scaleY = 1.5f;
                posy = SIZE_BOX / 10;
            } else {
                fxmlLoader.setLocation(Constants.getFxmlResource("gate.fxml"));
                scale = 3.8f;
                scaleY = 6;
                scaleZ = 3;
                posy = SIZE_BOX / 20;
    ...
    protected abstract class GameControl {
        ...
        */
        public void setToolBar(boolean multi) {
            ...
            quit = new Button();
            configButton("quit.png", quit); //TODO refactor, redundant
            ...
            MazeInterface.configLabel(piece,"coin.png",style1);
            Label key = new Label();
            key.textProperty().bind(nbKey.asString());
            MazeInterface.configLabel(key,"key.png",style1);
            save = new Button();
            ...
            save.setOnMouseClicked(e -> {
                ...
                try {
                    //TODO
                    game.save(Constants.SAVING_RESOURCES_PATH + File.separator +game.player().getName()+"--"+date[2] + "-" + date[1] + "-" + date[0].charAt(2) +date[0].charAt(3));
                } catch (Exception exc) {
                    exc.printStackTrace();
                }
            });
        ...
        public void configButton(String path, Button button) {
            Image img = new Image(Constants.getResourceAsStream("images/"+path), 50, 50, false, false);
            ...
            gameTimer = new AnimationTimer() {
                ...
                public void handle(long now) {
                    if (game.gameOver()) {
                        ...
                        final Image img = new Image(Constants.getResourceAsStream("images/death.png"));
                        imv.setImage(img);
                        ...
                        final ImageView imv = new ImageView();
                        final Image img = new Image(Constants.getResourceAsStream("images/over.png")); //TODO
                        imv.setImage(img);
                        main.getChildren().add(imv);
                        View.this.setOnKeyPressed(null);
                        gameTimer.stop();
        ...
        public void displayHelp(){
            ...
            //TODO return only folder name and append
            MazeInterface.configLabel(cle, Constants.getImgResourcePath("key.png"), style);
            String time = "Hourglasses will get you some extra time";
            Label hour = new Label(time);
            MazeInterface.configLabel(hour, Constants.getImgResourcePath("hourglass.png"), style);
            ...
            MazeInterface.configLabel(piece, Constants.getImgResourcePath("coin.png"), style);
